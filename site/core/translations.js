// ============================================================
// LAFA Translation Dictionary
// Spanish (es) + English (en) — consumed by i18n.js engine
// ============================================================

window.LAFA_TRANSLATIONS = {
  es: {
    ...
    'landing.fi.eyebrow': 'Desafío Técnico',
    'landing.fi.title': 'Fleet Intelligence',
    'landing.fi.subtitle': 'De hojas de cálculo a plataforma operativa. Turnos, nómina y flota — en una sola app.',
    'landing.fi.pill.shifts': 'Turnos y check-in',
    'landing.fi.pill.payroll': 'Nómina automática',
    'landing.fi.pill.roles': 'Permisos por rol',
    'landing.fi.cta': 'Abrir la App →',
    'landing.fi.credentials.label': 'Demo: admin@lafa.mx / admin123',
  ...
  en: {
    ...
    // ---- Fleet Intelligence section ----
    'landing.nav.fleetIntel': 'Fleet Intelligence',
    'landing.fi.eyebrow': 'Technical Challenge',
    'landing.fi.title': 'Fleet Intelligence',
    'landing.fi.subtitle': 'From spreadsheets to operations platform. Shifts, payroll, and fleet — in one app.',
    'landing.fi.pill.shifts': 'Shifts & check-in',
    'landing.fi.pill.payroll': 'Auto payroll',
    'landing.fi.pill.roles': 'Role permissions',
    'landing.fi.cta': 'Open the App →',
    'landing.fi.credentials.label': 'Demo: admin@lafa.mx / admin123',
    'landing.fi.tab.dashboard': 'Dashboard',
