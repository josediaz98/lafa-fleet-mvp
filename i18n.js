...
(function () {
  ...
  const I18N = {
    es: {
      ...
      'landing.hero.subtitle': 'LAFA gestiona 150 EVs con hojas de cálculo. Escalar a 2,000 requiere una capa tecnológica que hoy no existe. Diseñé un roadmap de 16 proyectos en 3 tracks — y construí 5 prototipos funcionales para demostrarlo.',
      ...
      'landing.problem.subtitle': 'LAFA está en Stage 0. Cada proceso que necesita escalar 13x es manual hoy.',
      ...
      'landing.tools.title': '5 Herramientas. Ya Prototipadas.',
      ...
      'landing.about.stackVal': 'Python, SQL, FastAPI, OpenAI API, Claude Code',
      'landing.about.quote': '"Construir todo sin necesitar un equipo grande de ingeniería"',
    ...
    en: {
      ...
      'landing.hero.subtitle': 'LAFA manages 150 EVs with spreadsheets. Scaling to 2,000 requires a tech layer that doesn\'t exist today. I designed a roadmap of 16 projects across 3 tracks — and built 5 working prototypes to prove it.',
      ...
      'landing.problem.subtitle': 'LAFA is at Stage 0. Every process that needs to scale 13x is manual today.',
      ...
      'landing.tools.title': '5 Tools. Already Prototyped.',
      ...
      'landing.about.stack': 'Stack',
      'landing.about.stackVal': 'Python, SQL, FastAPI, OpenAI API, Claude Code',
      'landing.about.quote': '"Build everything without needing a large engineering team"',
